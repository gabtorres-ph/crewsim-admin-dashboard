...
const inputStyles = tv({
  base: [
    ...
    [
      ...
      'file:border-solid file:border-gray-800 file:bg-gray-900 file:text-gray-300 file:hover:bg-gray-800 disabled:file:border-gray-700',
      'file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]',
      'disabled:file:bg-gray-800 disabled:file:text-gray-500',
    ],
    // focus
    focusInput,
