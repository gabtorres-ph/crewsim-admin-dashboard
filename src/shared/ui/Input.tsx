...
const inputStyles = tv({
  base: [
    ...
    // hover
    'enabled:hover:bg-gray-50 dark:enabled:hover:bg-gray-900',
    // disabled
    'disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:border-gray-700 dark:disabled:bg-gray-800',
    // file
    [
      ...
      'file:border-solid file:border-gray-300 file:bg-gray-50 file:text-gray-700 file:hover:bg-gray-100 disabled:file:border-gray-200 dark:file:border-gray-800 dark:file:bg-gray-900 dark:file:text-gray-300 dark:file:hover:bg-gray-800 dark:disabled:file:border-gray-700',
      'file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]',
      'disabled:file:bg-gray-100 disabled:file:text-gray-400 dark:disabled:file:bg-gray-800 dark:disabled:file:text-gray-500',
    ],
    // focus
    focusInput,
