  ...
  variants: {
    variant: {
      primary: [
        ...
        'hover:bg-blue-600',
        // disabled
        'disabled:bg-blue-950 disabled:text-blue-500',
      ],
      secondary: [
        // border
        ...
        // disabled
        'disabled:bg-gray-50 disabled:text-gray-400 dark:disabled:bg-gray-900 dark:disabled:text-gray-600',
      ],
      light: [
        // base
        'shadow-none',
      ...
      destructive: [
        ...
        'hover:bg-red-700',
        // disabled
        'disabled:bg-red-950 disabled:text-red-500',
      ],
    },
  },
  defaultVariants: {
